...
<head>
	...
	<link rel="icon" type="image/png" sizes="160x160" href="<?php echo base_url('assets/img/favicons/favicon-160x160.png') ?>">
	...
	<meta name="msapplication-TileImage" content="<?php echo base_url('assets/img/favicons/mstile-144x144.png') ?>">
